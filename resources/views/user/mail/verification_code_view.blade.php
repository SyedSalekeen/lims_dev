                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div id="wrapper">
                                        <div id="dialog">
                                            <div id="form">
                                                <form method="POST"
                                                    action="{{ route('branch_verification_code_submit') }}">
                                                    @csrf
                                                    <div class="ver-code-inp">
                                                        <input type="text" maxLength="1" name="num1" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                        -
                                                        <input type="text" maxLength="1" name="num2" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                        -
                                                        <input type="text" maxLength="1" name="num3" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                        -
                                                        <input type="text" maxLength="1" name="num4" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                        -
                                                        <input type="text" maxLength="1" name="num5" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                        -
                                                        <input type="text" maxLength="1" name="num6" size="1" min="0"
                                                            max="9" pattern="[0-9]{1}" />
                                                    </div>
