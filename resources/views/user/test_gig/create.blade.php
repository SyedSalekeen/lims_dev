            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::open(['route' => 'branch-test-gig.store', 'method' => 'POST']) !!}
                        <div class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section">Create New Test</h4>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="Number" class="form-control newinput" min="0" name="test_best_range"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" class="form-control newinput" name="test_unit"
