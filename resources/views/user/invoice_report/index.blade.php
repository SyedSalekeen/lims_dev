...
@section('content')
    ...
    <div class="row dono">
        <div class="col-12">
            ...
            @endif
            @if (Session::get('branch_invoice_delete'))
                <?php
                session()->forget('branch_invoice_delete');
                ?>
                <div class="alert my-2 alert-success">
                                ...
                                <tbody>
                                    @foreach ($add_test as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td> <button id="text" data-id="{{ $item->id }}"
                                                    class="btn back-button-color vendorBarCodeShow" data-toggle="modal"
                                                    data-target="#VendorBarCodeModal">
                                                    Bar Code
                                                </button>
                                            </td>
                                            <td>
                                                <button type="button" class="btn back-button-color">
                                                    <a style="color: #fff;"
                                                        href="{{ route('patient_invoice.edit', $item->id) }}"><i
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="{{ route('patient_invoice.destroy_delete', $item->id) }}"
    ...
    <!--Bar Code Modal -->
    <div class="modal fade" id="VendorBarCodeModal" tabindex="-1" role="dialog" aria-labelledby="ReceiptModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
