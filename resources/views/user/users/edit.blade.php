                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li><a class="btn btn-primary" href="{{ route('branch_user.index') }}"> <i
                    ...
                    <div class="card-body">
                        <div class="form form-horizontal">
                            <div class="form-body">
                                ...
                                <hr>
                                {!! Form::model($user_edit, ['method' => 'PATCH', 'route' => ['branch_user.update', $user_edit->id], 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="proFileImgSec d-flex gap-4">
                                            <div class="profileImg">
                                                @if ($user_edit->profile_image)
                                                    <img id="output"
                                                        src="{{ asset('uploads/profile/' . $user_edit->profile_image) }}"
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <select class="form-control"
                                                    ...
                                                    @foreach ($get_vendor_branch as $item)
                                                        <option value="{{ $item->id }}" {{$item->id == $user_edit->branch_id ? 'selected' : ''}}>{{ $item->branch_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                                <a href="{{ route('branch_user.index') }}" type="submit"
