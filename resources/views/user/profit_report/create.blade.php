            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::open(['route' => 'branch_profit_report.store', 'method' => 'POST']) !!}
                        <div class="form form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="Number" class="form-control newinput" name="profit_amount"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="Date" class="form-control newinput" name="profit_date" required=""
                                            placeholder="Date">
                                    </div>
                                </div>
