...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            @if (Session::get('branch_profit_one_field_required'))
            <?php
            session()->forget('branch_profit_one_field_required');
            ?>
            <div class="alert my-2 alert-danger">
                <p>{{ 'One field is required' }}</p>
            </div>
        @endif
        @if (Session::get('branch_profit_deleted'))
            <?php
            session()->forget('branch_profit_deleted');
            ?>
            <div class="alert my-2 alert-danger">
        ...
        @endif
            ...
            {!! Form::open(['route' => 'branch_profit_report.filterReports', 'method' => 'POST']) !!}
            <div class="form form-horizontal mb-5">
                <div class="form-body">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center filter_button">
                        @if (@$data)
                        <a href="{{ route('branch_profit_report.index') }}">
                            <button type="button"
            ...
            <div class="card mt-5">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <a href="{{ route('branch.profit_export') }}" class="btn back-button-color float-left box-shadow-1 mt-1 mb-1 mr-1"><i
                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li>
                                <a href="{{ route('branch_profit_report.create') }}"><button class="btn create-new-button"><i
