...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            @if (Session::get('branch_report_created'))
                <?php
                session()->forget('branch_report_created');
                ?>
                <div class="alert my-2 alert-success">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                                ...
                                                aria-label="Role: activate to sort column ascending">Test Category
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                                colspan="1" style="width: 100px;"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a target="_blank" class="btn  btn-success btn-sm box-shadow-1 mr-1"
                                                        href="{{ route('branch_patient_report.show', $item->id) }}"><i
                                                            class="ft-eye"></i>View</a>
                                                </td>
                                                <td>
                                                    <center class="for-button-inline">

                                                        <a href="{{ route('branch_patient_report.destroy_delete', $item->id) }}"
