                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li>
                                <a href="{{ route('branch_perission.create') }}"><button class="btn create-new-button"><i
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <center class="for-button-inline">
                                                <a href="{{ route('branch_perission.show', $value->id) }}"
                                                    class="btn bstm-color-btnns btn-circle"
                                                    style="background-color: #007bff !important;color:#fff;"
                                                    data-toggle="tooltip" data-original-title="Edit">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('branch_perission.edit', $value->id) }}"
                                                    class="btn bstm-color-btnns btn-circle"
                                                    style="background-color: #007bff !important;color:#fff;"
                                                    data-toggle="tooltip" data-original-title="Edit">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                                <a href="{{ route('branch_perission.destroy_delete', $value->id) }}"
