...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @if (Session::get('branch_additional_report_deleted'))
                <?php
                session()->forget('branch_additional_report_deleted');
                ?>
                <div class="alert my-2 alert-success">
                    <p>{{ 'Report deleted successfully' }}</p>
                </div>
            @endif
            @if (Session::get('branch_additional_report_created'))
                <?php
                session()->forget('branch_additional_report_created');
                ?>
                <div class="alert my-2 alert-success">
                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li>
                                <a href="{{ route('branch_additional_report.create') }}"><button
                                        class="btn create-new-button"><i class="fas fa-plus"></i> Add New
                                        Report</button></a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div style="background: white;padding:24px 10px;">
                        <div>
                            <table id="myTable" class="table w-100 dataTable no-footer dtr-inline" role="grid"
                                ...
                                <tbody>
                                    @foreach ($getAdditionalBranchReports as $item)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <center class="for-button-inline">
                                                    ...
                                                    <a href="{{ route('branch_additional_report.destroy_delete', $item->id) }}"
