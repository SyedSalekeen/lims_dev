            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::open(['route' => 'branch_expensive_report.store', 'method' => 'POST']) !!}
                        <div class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i>Add Expense Report</h4>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Name</label>
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" class="form-control newinput" name="expensive_name" required=""
                                            placeholder="Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="Number" class="form-control newinput" min="0" name="expensive_amount"
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="projectinput1">Date</label>
                                    <div class="col-md-9 mx-auto">
                                        <input type="Date" class="form-control newinput" min="0" name="expensive_date"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" class="form-control newinput" name="expensive_description"
