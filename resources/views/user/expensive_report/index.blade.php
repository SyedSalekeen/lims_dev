...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            @if (Session::get('branch_expensive_one_fileld_required'))
                <?php
                session()->forget('branch_expensive_one_fileld_required');
                ?>
                <div class="alert my-2 alert-danger">
            ...
            <div class="card mt-5">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <a href="{{ route('branch.expensive_export') }}"
                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li>
                                <a href="{{ route('branch_expensive_report.create') }}"><button
                                        class="btn create-new-button"><i class="fas fa-plus"></i> Create
                                        New</button></a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <center class="for-button-inline">
                                                    <a href="{{ route('branch_expensive_report.edit', $item->id) }}"
                                                        class="btn bstm-color-btnns btn-circle"
                                                        style="background-color: #007bff !important;padding: 6px 10px"
                                                        data-toggle="tooltip" data-original-title="Edit">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                    <a href="{{ route('branch_expensive_report.destroy_delete', $item->id) }}"
