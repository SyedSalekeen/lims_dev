...
<body style="margin:50px 0;">
    <table style="text-align: center;">
        <thead>
            ...
            {{-- <tr>
                <td style="width: 220px; height: 80px">
              <img id="output" src="{{ asset('uploads/logo/' . $get_vendor->laboratory_logo) }}"  width='100%' height='100%' />
                </td>
            </tr> --}}
        </thead>
    </table>
        ...
        <tbody>
            @foreach ($reportDetails as $item)
                <tr>
                    ...
                    <td style="text-align:left;padding-left: 20px">U/L</td>
