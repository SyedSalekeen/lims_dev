<?php
$get_auth_user = App\User::find(auth()->id());
$get_color = App\ChangeTheme::where('branch_id',$get_auth_user->branch_id)->first();
?>
@if ($get_color)
<style>
    :root {
...
@endif
@include('patient.components.admin-header')
@include('patient.components.admin-navbar')
@include('patient.components.admin-sidebar')


<div class="app-content content">
    <div class="content-overlay"></div>
    <div class="content-wrapper">
        @include('patient.components.admin-breadcrumb')
...
<!-- END: Footer-->
@yield('scripts')
@include('patient.components.admin-footer')
