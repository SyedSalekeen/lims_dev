            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::model($get_profit_reports, ['method' => 'PATCH', 'route' => ['profit_report.update',$get_profit_reports->id]]) !!}
                        <div class="form form-horizontal">
                            <div class="form-body">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <select class="form-select cstm-slect" name="branch"
                                            ...
                                            @foreach ($get_vendor_branch as $item)
                                                <option value="{{ $item->id }}" <?php if($get_profit_reports->branch_id == $item->id)
                                                    echo "selected";
                                                    ?>>{{ $item->branch_name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <input type="Number" class="form-control newinput" min="0" value="{{$get_profit_reports->profit_amount}}" name="profit_amount"
