                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li><a class="btn btn-primary" href="{{ route('test_report.index') }}"> <i
                ...
                <div class="card-content collpase show">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Invoice Modification</h4>
                                <hr>
                                {!! Form::model($edit_test, ['method' => 'PATCH', 'route' => ['test_report.update', $edit_test->id]]) !!}
                                <div class="form form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="Date" class="form-control newinput" value="{{$edit_test->report_issue_date}}" name="report_issue_date"
                                                    required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="Number" readonly class="form-control newinput"
                                                    id="test_amount" name="test_amount" required=""  value="{{$edit_test->test_amount}}" placeholder="Amount">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="Number" id="discount_amount"  value="{{$edit_test->test_discount_amount}}" class="form-control newinput test-dis" name="test_discount_amount"
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="Number" id="additional_discount_amount"  value="{{$edit_test->additional_discount_amount}}" class="form-control newinput additional-dis" name="additional_discount_amount"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9 mx-auto">
                                                <input type="Number" id="total_test_amount"  value="{{$edit_test->total_test_amount}}" readonly class="form-control newinput" name="total_test_amount"
