...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            @if (Session::get('edit_test_delete'))
                <?php
                session()->forget('edit_test_delete');
                ?>
                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li><a class="btn back-button-color" href="{{ route('add_test.index') }}"> <i
                                        ...
                                        <div class="box-for-shodow">
                                            <div class="col-lg-12">
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <input type="hidden" name="AddTestId"
                                                            value="{{ $get_add_test->id }}">
                                                        <label for="">Location</label>
                                                        <select name="branch" required="" id="" class="for-s-width">
                                                            <option selected disabled>Select Branch</option>
                                                            @foreach ($get_vendor_branch as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ $item->id == $get_add_test->branch_id ? 'selected' : '' }}>
                                                                    {{ $item->branch_name }}
                                                                </option>
                                                            @endforeach
                                                            {{-- <option value="">----</option>
                                                    ...
                                                    @foreach ($get_test_gig as $item)
                                                        <div class="col-lg-4">
                                                            <div class="cards-boxs">
                                                                ...
                                                                <button type="button" class="disableid back-button-color"
                                        ...
                                        <div class="box-for-shodow">
                                            <div class="col-lg-10">
                                                ...
                                                <div class="date-time mt1">
                                                    <label>Time</label>
                                                    <input type="Time" class="form-control newinput"
                                                        value="{{ $get_add_test->booking_time }}" name="time"
                                                        required="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                            ...
                                                            <div class="date-time mt1">
                                                                ...
                                                                <select id="mySelect2"
                                                                    ...
                                                                    @foreach ($get_patients as $item)
                                                                        <option value="{{ $item->id }}"
                                                                            {{ $item->id == $get_add_test->patient_mr_no ? 'selected' : '' }}
                                                                                ...
                                                                                <div class="col-lg-10">
                                                                                    <div class="date-time mt1">
                                                                                        ...
                                                                                        <select
                                                                                            ...
                                                                                            @foreach ($get_patients as $item)
                                                                                                <option
                                                                                                    value="{{ $item->fullname }},{{ $item->patient_email }}"
                                                                                                    data-id="{{ $item->id }}">
                                                                                                    {{ $item->fullname }}
                                                                                                </option>
                                                                                            @endforeach
                                                    ...
                                                    <tbody id="append_gig_details">
                                                        @foreach ($get_add_test_details as $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="hidden" id="first_amount{{ $item->id }}"
                                            ...
                                            <div class="red-par">
                                                <p>If you delete any test you must have to complete the whole process</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                               <div class="col-lg-12 for-align-btnstext">
                                <button class="btn back-button-color">Next</button>
                               </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="for-transparent">
                                                ...
                                                <td class="for-transparent" id="cash_given"></td>
            ...
            <div class="modal fade" id="exampleModal3" role="dialog" aria-labelledby="exampleModalLabel2"
                ...
                <div class="modal-dialog modal-m" role="document">
                    <div class="modal-content grey-color">
                        ...
                        <form action="{{ route('edit_payement_submit') }}" method="POST">
                            @csrf
                            <div class="modal-body">
                                <div class="col-lg-12">
                                    <div>
                                ...
                                {{-- <div class="col-lg-10 mt1">
                                    <div class="pay-chech-box" id="pills-tabContent">
                                        ...
                                        <div class="">
                                            <input type="radio" name="payement_method" id="cash-radio" value="cash">
                                            <label>Pay By Cash</label>
                                        </div>
                                        <div class="">
                                            <input type="radio" class="" name="payement_method"
                                                id="card-radio" value="card">
                                            <label>Pay By Card</label>
                                        </div>
                                        <div class="">
                                            <input type="radio" class="" name="payement_method"
                                                id="later-radio" value="later">
                                ...
                                <div id="myDIV">
                                    <div class="col-lg-12 mt1">
                                        <div class="cash-input">
                                            ...
                                            <input type="text" id="cash_given_by_customer"
                                                class="form-control cash_given_by_customer" name="cash_given" required="">
                                        </div>
                                    </div>
                                    <div class="row mt1 for-padding-row">
                                        <div class="col-lg-6">
                                            <label>Cash Remaing</label>
                                            <input id="cash_remaining" name="cash_remaining" type="text">

                                        </div>
                                        <div class="col-lg-6">
                                            <label>Cash To Return</label>
                                            <input id="cash_return" name="cash_return" type="text">
                                        </div>
                                    </div>
                                ...
                                <div id="myDIV">
                                    <div class="col-lg-12 mt1">
                                        <div class="cash-input">
                                            <label>Cash given by customer</label>
                                            <input type="text" id="cash_given_by_customer"
                                                class="form-control cash_given_by_customer" name="cash_given">
                                        </div>
                                    </div>
                                    <div class="row mt1 for-padding-row">
                                        <div class="col-lg-6">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn submit-button-color" data-dismiss="modal">Pay</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        @section('scripts')
            ...
            <tr id='remove-${response.gig_data.id}'>
                            ...
                            <input type="hidden" id="amount${response.gig_data.id}" value=${response.gig_data.test_amount} name="actual_amont[]">
                                ...
                                <td id="removetd">
                                    <a class="btn btn-danger myClass" onclick="return myFunction('remove-${response.gig_data.id}');" value=${response.gig_data.id} href="#">
                                        <i class="fa fa-times"></i>
                                    </a>
                                </td>
                ...
                $(document).ready(function() {
                    ...
                    $('#editTest').on("submit", function(event) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('edit_test.edit_test_store') }}",
                            data: formData,
                            contentType: false,
                            processData: false,
                            success: function(response) {
                                ...
                                document.getElementById("cash_given").innerHTML = response.success.amount;
                    ...
                    $('#editAddPayement').on("submit", function(event) {
                        event.preventDefault();
                        var formData = new FormData(this);
                        $.ajaxSetup({
                            headers: {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "{{ route('edit_add_testPayement') }}",
                            data: formData,
                            contentType: false,
                            processData: false,
                            success: function(response) {
