                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            {{-- <li>
                                <a href="{{ route('add_test.create') }}" id="add_item" class="btn btn-success">
                                    <i class="ft-plus"></i>
                                </a>
                            </li> --}}
                            {{-- <li>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                            ...
                                            aria-label="Employee Group: activate to sort column ascending">Tewst Amount
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1"
                                            colspan="1" style="width: 120px;"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <center class="for-button-inline">
                                                    ...
                                                    <a href="{{ route('add_test.edit', $item->id) }}"
                                                        class="btn bstm-color-btnns btn-circle"
                                                        style="background-color: #007bff !important;padding: 6px 10px"
                                                        data-toggle="tooltip" data-original-title="Edit">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                    <a href="{{ route('add_test.destroy_delete', $item->id) }}"
                                                        class="btn bstm-color-btnns btn-danger btn-circle delete-row"
                                ...
                                <div class="box-for-shodow">
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <select name="branch" id="validateSelect" class="for-styling-input">
                                            ...
                                            <div class="for-position">
                                                ...
                                                <div class="col-lg-2">
                                                    <a href="{{ route('patient.create') }}">
                                                        <button type="button" class="btn back-button-color for-top-0">Add
                                                            Patient</button>
                                                        <a>
                                                </div>
    ...
    <div class="modal fade" id="exampleModal3" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-m" role="document">
            <div class="modal-content grey-color">
                ...
                <form action="{{ route('payement_submit') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="col-lg-12">
                            <div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const appendDocumentNotes = (data) => {
                ...
                if (data.length > 0) {
                    ...
                    $('#appendSearchTest').html(
                        `<div class="d-flex justify-content-center align-items-center" style='width:100%; color:#000; font-size:25px;'>No   Found </div>`
                    )
                }
            }
            ...
            $('#addTest').on("submit", function(event) {
                ...
                select = document.getElementById("validateSelect");
                if (select.value != "Select Branch") {

                    $.ajax({
                        type: "POST",
                        url: "{{ route('add_test.store') }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function(response) {
        ...
        $(document).ready(function() {
            ...
            // $('.editModalOne').on("click", function(event) {
            //     console.log("here");
            //     var id = $(this).data('id');
            //     $.ajaxSetup({
            //         headers: {
            ...
            //     $.ajax({
            //         type: "POST",
            //         url: "{{ route('edit_test.edit_invoice') }}",
            //         dataType: "json",
            //         data: {
            //             id: id,
            //         },
