                            ...
                            <div class="form form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                            <button type="submit" onclick="submitFormInvoice();"
                                                class="btn btn-success float-right box-shadow-1 mt-1 mb-1 ">
                                                <i class="ft-check"></i>
                                                Save And Create Invoice
                                            </button>
                                            <button id="modalTrigger" hidden data-toggle="modal"
                                                ...
                                                <div class="for-position">
                                                    <div class="col-lg-10">
                                                        <div class="date-time mt1">
                                                            ...
                                                            <input type="hidden" class="form-control newinput" readonly
                                                                name="patient_id" id="patientId" value="" required="">
                                                        </div>
                                                    </div>
        ...
        <div class="modal fade" id="exampleModal2" role="dialog" aria-labelledby="exampleModalLabel2"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content grey-color">
                    ...
                    <button id="modalTriggerThree" hidden data-toggle="modal" data-target="#exampleModal3"></button>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="exampleModal3" role="dialog" aria-labelledby="exampleModalLabel2"
            ...
            <div class="modal-dialog modal-m" role="document">
                <div class="modal-content grey-color">
                    ...
                    <form action="{{ route('patient_payement_submit') }}" method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="col-lg-12">
                                <div>
                            ...
                            {{-- <div class="col-lg-10 mt1">
                                <div class="pay-chech-box" id="pills-tabContent">
                                    ...
                                    <div class="">
                                        <input type="radio" class="" name="payement_method" id="card-radio"
                                            value="card">
                                        <label>Pay By Card</label>
                                    </div>
                                    <div class="">
                                        <input type="radio" class="" name="payement_method" id="later-radio"
                                            value="later">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn submit-button-color">Pay</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function submitFormInvoice() {
                $('#formInvoice').on("submit", function(event) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('patient.store_create_invoice') }}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function(response) {
                            ...
                            submitted = true;
                            something();
                            $('#PatientName').val(response.data.fullname);
                            $('#patientId').val(response.data.email);
                            $('#branchId').val(response.data.branch_id);
                        },
            ...
            $('#addTest').on("submit", function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('patient_add_test.store_add_test') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
            ...
            $('#addPayement').on("submit", function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('patient_add_test_payement') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        document.getElementById("final_amount").innerHTML = response.success.amount;
                        $('#exampleModal2').hide()
