                ...
                <div class="card-header">
                    ...
                    <div class="heading-elements">
                        <ul class="list-inline mb-0">
                            ...
                            <li> <a class="btn btn-primary" href="{{ route('role_permission.index') }}"> <i
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        <select class="form-select cstm-slect" name="branch" hidden
                                            aria-label="Default select example">
                                            <option selected disabled>Select Branch</option>
                                            @foreach ($get_vendor_branch as $item)
                                                <option value="{{ $item->id }}" <?php if($get_permission->branch_id == $item->id)
                                                    echo "selected";
                                                    ?>>{{ $item->branch_name }}
                                                </option>
                                            @endforeach
