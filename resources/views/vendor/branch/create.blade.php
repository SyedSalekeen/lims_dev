            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::open(['route' => 'branch.storeBranch', 'method' => 'POST']) !!}
                        <div class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section"><i class="ft-user"></i> Create New Branch</h4>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 mx-auto">
                                        ...
                                        <input class="newinput" type="text" hidden placeholder="" name="branch_name"
                                            id="branchSlug" required="">
                                        <input type="text" hidden name="branch_url" value="<?php echo config('app.url'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    <a href="{{ route('branch.index') }}" type="submit"
