            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'vendor_user.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="form form-horizontal">
                            <div class="form-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    <button type="submit" class="btn submit-button-color float-right box-shadow-1 mt-1 mb-1">
                                        <i class="ft-check"></i>
                                        Submit
                                    </button>
                                </div>
