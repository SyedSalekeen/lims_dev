...
@section('content')
    ...
    @if (Session::get('vendor_profile_updated'))
        <?php
        session()->forget('vendor_profile_updated');
        ?>
    ...
    <!-- eCommerce statistic -->
    <div>
        <a href="{{route('vendor_theme_change.index')}}">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card-patient">
                        <a href="{{ route('vendor_user.index') }}">
                            <div>
                                <h2>Employees<h2>
                            </div>
                            <div>
        ...
        <div class="card-row">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card-patient">
                        <a href="{{ route('test_report.index') }}">
                            <div>
